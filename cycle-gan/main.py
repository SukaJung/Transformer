...
class CycleGAN():
    def input_setup(self):
        ...
        filenames_A = tf.train.match_filenames_once("/home/suka/dataset/cyclegan/cezanne2photo/trainA/*.jpg")
        self.queue_length_A = tf.size(filenames_A)
        filenames_B = tf.train.match_filenames_once("/home/suka/dataset/cyclegan/cezanne2photo/trainB/*.jpg")
    ...
    def input_read(self, sess):
        ...
        for i in range(max_images):
            ...
            if (image_tensor.shape[0]*image_tensor.shape[1]*image_tensor.shape[2] == img_size * batch_size * img_layer):
    ...
    def train(self):
        ...
        # Build the networktf.global_variables_initializer()
        self.model_setup()
        ...
        with tf.Session() as sess:
            ...
            # Training Loop
            for epoch in range(sess.run(self.global_step), 1000):
